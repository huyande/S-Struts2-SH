										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<td>所属客户：</td>
													<td colspan="3">
														<s:select list="customers" name="customer.custId" listKey="custId" listValue="custName" headerKey="" headerValue="---请选择---" style="WIDTH: 80px"/>
													</td>
													<td>联系人性别：</td>
													<td>
														<s:select list="#{'male':'男','female':'女'}" headerKey="" headerValue="---请选择---" name="lkmGender"/>
													</td>
													<TD>
														<s:submit value=" 筛选 "/>
													</TD>
